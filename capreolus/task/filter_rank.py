#!/usr/bin/env python
# -*- coding: utf-8 -*-
# author：Crystina Zhang time:15/5/2020
...
def train(config, modules):
    ...
    best_results_path = evaluator.search_best_run(
    ...
    search_results_folder = rerank_searcher.query_from_file(topics_fn, rerank_path, run_fn=best_results_path)
...
class RankTask(Task):
    def pipeline_config():
        ...
        seed = 123_456
        fold = "s1"
        optimize = "mrr"  # metric to maximize on the dev set
